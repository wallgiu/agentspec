...
│   │   │                    #   authoring (component-model, skill-create*, agent-create*),
...
| `.claude/skills/skill-create/` · `agent-create/` · `kb-build/` | Authoring SOPs: new skills and agents (repo-local; skill-create defers to upstream `skill-creator`), high-assurance KB domains |
