...
Templates are the fifth, narrower piece: an artifact's required shape, owned in one place (`.claude/sdd/templates/`, `.claude/kb/_templates/`) and referenced by skills — never re-inlined.
