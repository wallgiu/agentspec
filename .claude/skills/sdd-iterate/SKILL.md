...
`iterate` block in `.claude/sdd/architecture/WORKFLOW_CONTRACTS.yaml` owns the command surface,
...
(`.claude/sdd/templates/DEFINE_TEMPLATE.md`, `DESIGN_TEMPLATE.md`):
...
- Entrypoint: `.claude/commands/workflow/iterate.md`
